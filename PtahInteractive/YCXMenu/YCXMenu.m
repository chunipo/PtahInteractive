...
#define kTintColor  [UIColor whiteColor]  //!< 主题颜色
...
- (UIView *)mkContentView {
    ...
    const CGFloat kMinMenuItemHeight = 32.f;//两个之间上下距离
    const CGFloat kMinMenuItemWidth = 32.f;
    const CGFloat kMarginX = 20.f;//相对左右距离
    ...
    for (YCXMenuItem *menuItem in _menuItems) {
        ...
        if (imageSize.width > maxImageWidth)
            maxImageWidth = imageSize.width;//图片大小
    }
